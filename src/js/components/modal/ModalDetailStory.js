...
class ModalDetailStory extends LitWithoutShadowDom {
  ...
  render() {
    return html`
      <div class="modal-dialog custom-modal-lg custom-modal-dialog-scrollable">
        <!-- Add 'custom-modal-lg' class for your custom modal size -->
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="mb-3">
              <img src="" id="imgDetailRecord" class="img-fluid rounded custom-img" alt="">
            </div>
            <div class="row mt-2">
